...
<div class="container">
	...
	{foreach from=$oAdmin->getEntityTypes() key="sEntityType" item="sEntityTypeName"}
	  <li class="nav-item">
	    <a class="nav-link active" id="pills-{$sEntityType}-tab" data-toggle="pill" href="#pills-{$sEntityType}" role="tab" aria-controls="pills-{$sEntityType}" aria-selected="true">{$sEntityTypeName}</a>
	  </li>
	{/foreach}
	</ul>
	<div class="tab-content" id="pills-tabContent">
	{foreach from=$oAdmin->getEntityTypes() key="sEntityType" item="sEntityTypeName"}
		<div class="tab-pane fade show active" id="pills-{$sEntityType}" role="tabpanel" aria-labelledby="pills-{$sEntityType}-tab">
